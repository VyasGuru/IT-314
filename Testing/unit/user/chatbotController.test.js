...
describe('Chatbot Controller', () => {
  ...
  describe('echoChatHandler', () => {
    ...
    it('should handle Groq API failure with error that has no message property', async () => {
      // Create an error object without a message property to test the ternary operator
    ...
    it('should handle specific error conditions in catch block', async () => {
  ...
  describe('getChatHistory', () => {
    ...
    it('should handle null or undefined records from database', async () => {
      ChatMessage.find.mockReturnValue({
        sort: vi.fn().mockReturnValue({
