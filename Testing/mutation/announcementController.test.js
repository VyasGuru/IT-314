...
describe('Announcement Controller', () => {
  ...
  describe('createAnnouncement', () => {
    ...
    it('should verify exact success message for announcement creation', async () => {
      // Arrange
      const mockAnnouncement = {
        _id: '123',
        message: 'Test announcement',
      ...
      // Assert - Verify the exact ApiResponse constructor call
      const jsonCall = mockRes.json.mock.calls[0][0];
      expect(jsonCall.message).toBe('Announcement created successfully');
    });
  ...
  describe('getAnnouncements', () => {
    ...
    it('should verify exact success message for announcements fetch', async () => {
      // Arrange
      const mockData = {
        announcements: [{ _id: '1', message: 'Test' }],
        pagination: {
      ...
      // Assert - Verify the exact ApiResponse constructor call
      const jsonCall = mockRes.json.mock.calls[0][0];
      expect(jsonCall.message).toBe('Announcements fetched successfully');
    });
  ...
  describe('deleteAnnouncement', () => {
    ...
    it('should verify exact success message and data for announcement deletion', async () => {
      // Arrange
      const mockDeleted = { _id: '123' };
      mockReq.params = { id: '123' };
      removeAnnouncement.mockResolvedValue(mockDeleted);
      ...
      // Assert - Verify the exact ApiResponse constructor call with correct data and message
      const jsonCall = mockRes.json.mock.calls[0][0];
      expect(jsonCall.data).toEqual({ id: '123' });
      expect(jsonCall.message).toBe('Announcement deleted successfully');
    });
